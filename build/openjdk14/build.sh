...
if [ ! -f openjdk/$JDK_ARCHIVE ] ; then
   ...
   mkdir -p openjdk
   hg clone $OPENJDK_REPO/jdk14u openjdk/$JDK_SRCDIR
   (cd openjdk/$JDK_SRCDIR && hg update jdk-14.0.1-ga)
   ...
   echo 'aa41c9fb9e272340dc007f08c997232149db8e4ab591959950614b258f7b0393' > openjdk/$JDK_ARCHIVE.sha256
...
IFULL=`pwd`/../openjdk13/tmp/build/jdk
